...
module Fastlane
  ...
  module Helper
    ...
    class RepackIosHelper
      ...
      # as `Helper::RepackIosHelper.your_method`
      #
      def self.getSigningIdentityFromProvisionProfile (provisioning_profile)
      ...
      def self.unpackAndRepack(output_name, ipa_path, contents)
        ...
        begin          
          ...
          patch_ipa_contents(contents, ipa_new_payload_path, dereference_root = true)
